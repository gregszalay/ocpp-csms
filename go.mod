module github.com/gregszalay/ocpp-csms
...
require (
	...
	github.com/gregszalay/firestore-go v0.0.0-20221002200711-639573dfc2d8
	github.com/gregszalay/ocpp-csms-common-types v0.0.0-20221014160809-cc4d653e9116
